                    ...
                    <div class="portlet-body">
                        <div class="panel">
                            <div class="panel-body pan">
                                {!! Form::open(['url'=>'user/store-dvlt', 'id' => 'create-user', 'class'=>'form-horizontal form-validate']) !!}
                                ...
                                <div class="portlet-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 controls">
                                            <input id="name" class="form-control required" name="name" type="text" value="Doanh nghiệp cung cấp dịch vụ lưu trú" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
