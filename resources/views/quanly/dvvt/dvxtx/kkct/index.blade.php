...
@section('content')
                ...
                <form>
                    <div class="portlet box">
                        <div class="portlet-header">
                            ...
                            <div class="actions">
                                <a href="{{url('dvvantai/dvxtx/print/'.$masokk)}}" target="_blank" class="btn btn-info"><i class="fa fa-print"></i> In kê khai </a>
                            </div>
                        </div>
                                                    ...
                                                    <td>
                                                        @if(session('admin')->level == 'H')
                                                            @if($modelkk->trangthai == 'Chờ chuyển')
                                                                <a href="{{url('dvvantai/dvxtx/chitiet/edit/'.$giadv->id.'')}}" class="btn btn-info btn-xs mbs">&nbsp;Chỉnh sửa</a>
    ...
    <script>
        function confirmDelete(id) {
            $('#frmDelete').attr('action', "/dvvantai/dvxtx/chitiet/del/" + id);
        }
    </script>
