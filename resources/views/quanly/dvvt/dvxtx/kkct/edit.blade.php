            ...
            <div class="col-lg-12">
                <div class="portlet box">
                    <div class="portlet-header">
                        <div class="caption">
                            <b>CHỈNH SỬA GIÁ DỊCH VỤ VẬN TẢI HÀNH KHÁCH BẰNG XE TAXI</b>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="panel">
                            <div class="panel-body pan">
                                {!! Form::model($model, ['method' => 'PATCH', 'url'=>'dvvantai/dvxtx/chitiet/update/'.$idkk.'/'.$model->id, 'class'=>'form-horizontal form-validate']) !!}
