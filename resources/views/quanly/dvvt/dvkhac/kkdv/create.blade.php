...
@section('content')
        ...
        <div id="" class="row">
            <div class="col-lg-12">
                <div class="panel panel">
                    <div class="panel-heading">Kê khai giá dịch vụ vận tải chở hàng</div>
                    <div class="panel-body pan">
                        {!! Form::open(['url'=>'dvvantai/dvkhac/kekhai/store', 'id' => 'create-dvkhac','class'=>'horizontal-form form-validate','method'=>'patch']) !!}
    ...
    <script>
        ...
        function updategia(){
            ...
            $.ajax({
                url: '/dvvantai/dvkhac/kekhai/updategiadv',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    giakklk: $('#giakklk').val(),
