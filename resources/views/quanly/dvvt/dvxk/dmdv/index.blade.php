...
@section('custom-script')
    ...
    <script>
        function confirmDelete(id) {
            $('#frmDelete').attr('action', "deldvxk/" + id);
        }
    </script>
                ...
                <form id="view_user">
                    <div class="portlet box">
                        <div class="portlet-header">
                            <div class="caption">
                                <b>THÔNG TIN DỊCH VỤ VẬN TẢI BẰNG XE KHÁCH</b>
                            </div>
                            <div class="actions">
                                <a href="{{url('dvvantai/dvxekhach/create')}}" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> Thêm mới</a>
                            </div>
                        </div>
                                        ...
                                        <table id="table_id"class="table table-hover table-striped table-bordered table-advanced tablesorter">
                                            ...
                                            @foreach($model as $dv)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('dvvantai/dvxekhach/'.$dv->id.'/edit')}}" class="btn btn-info btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
