                    ...
                    <div class="portlet-body">
                        <div class="panel">
                            <div class="panel-body pan">
                                {!! Form::open(['url'=>'user/store-quan-ly', 'id' => 'create-user', 'class'=>'form-horizontal form-validate']) !!}
                                <meta name="csrf-token" content="{{ csrf_token() }}" />
                                <div class="portlet-body">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Cấp sử dụng
                                        </label>
                                        <div class="col-sm-4 controls">
                                            <input id="name" class="form-control required" name="name" type="text" value="Đơn vị quản lý" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 controls">
                                            <input id="name" class="form-control required" name="name" type="text" autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
