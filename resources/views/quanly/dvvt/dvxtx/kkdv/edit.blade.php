...
@section('content')
            ...
            <div class="col-lg-12">
                <div class="panel panel">
                    ...
                    <div class="panel-body pan">
                        {!! Form::open(['url'=>'dvvantai/dvxtx/kekhai/update/'.$model->id, 'id' => 'create-kkdvxk','class'=>'horizontal-form form-validate','method'=>'patch']) !!}
    ...
    <script>
        ...
        function updategia(){
            ...
            $.ajax({
                url: '/dvvantai/dvxtx/kekhai/updategiadvct',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    masokk:$('#makk').val(),
