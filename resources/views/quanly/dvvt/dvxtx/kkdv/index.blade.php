                                        ...
                                        <table id="table_id"class="table table-hover table-striped table-bordered table-advanced tablesorter">
                                            ...
                                            @foreach($model as $kk)
                                                <tr>
                                                    ...
                                                    @endif
                                                    <td>
                                                        <a href="{{url('dvvantai/dvxtx/chitiet/danhsach/'.$kk->id)}}" class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Chi tiết</a>

                                                        @if($kk->trangthai == "Chờ chuyển")
                                                            <a href="{{url('dvvantai/dvxtx/kekhai/'.$kk->id.'/edit')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
                                                        ...
                                                        @elseif($kk->trangthai == 'Chờ duyệt')
                                                            @if(session('admin')->level == 'T')
                                                                ...
                                                                <a href="{{url('dvvantai/dvxtx/kekhai/'.$kk->id.'/edit')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Ngày nhận HS</a>
                                                            @endif
                                                        @else
                                                            @if(session('admin')->level == 'T')
                                                                <a href="{{url('dvvantai/dvxtx/kekhai/'.$kk->id.'/edit')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Ngày nhận HS</a>
