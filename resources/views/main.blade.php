                    ...
                    <li id="navdvlt"><a href="{{url('')}}"><i class="fa fa-desktop fa-fw"></i><span class="menu-title">Dịch vụ vận tải xe buýt</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            @if(session('admin')->level=='H' || session('admin')->level == 'X')
                                ...
                                <li><a href="{{url('dvvantai/dvxb/kekhai/index')}}"><i class="fa fa-ambulance"></i><span class="submenu-title">Kê khai giá dịch vụ vận tải hành khách bằng xe buýt</span></a> </li>
                            @elseif(session('admin')->level == 'T')
                                <li><a href="{{url('dvvantai/dvxb/kekhai/accept')}}"><i class="fa fa-user fa-fw"></i><span class="submenu-title">Xét duyệt kê khai giá dịch vụ xe buýt</span></a> </li>
                            @endif
                        </ul>
                    </li>
