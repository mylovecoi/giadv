...
@section('custom-script')
    ...
    <script>
        function confirmDelete(id) {
            $('#frmDelete').attr('action', "/dvvantai/dvxb/thaotac/delete/" + id);
        }

        function confirmTraLai(id) {
            $('#frmTraLai').attr('action', "/dvvantai/dvxb/thaotac/tralai/" + id);
        }
...
@section('content')
                    ...
                    <div class="portlet box">
                        <div class="portlet-header">
                            <div class="caption" style="text-transform:uppercase" >
                                <b>KÊ KHAI GIÁ DỊCH VỤ VẬN TẢI HÀNH KHÁCH BẰNG XE BUÝT THEO TUYẾN CỐ ĐỊNHH</b>
                            </div>
                            <div class="actions">
                                <a href="{{url('dvvantai/dvxb/kekhai/create')}}" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> Kê khai giá mới</a>
                            </div>
                        </div>
    ...
    <script>
        ...
        function InChiTiet(masokk){
            var url='/dvvantai/dvxb/print/'+ masokk;
        ...
        function clickTraDVVT() {
            ...
            if ($('#idtra').attr('value') != 'null') {
                ...
                $.ajax({
                    url: '/dvvantai/dvxb/thaotac/tralai',
                    type: 'GET',
                    data: {
                        _token: CSRF_TOKEN,
                        id: $('#idtra').val(),
