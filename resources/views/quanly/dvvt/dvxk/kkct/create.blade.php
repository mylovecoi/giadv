                    ...
                    <div class="portlet-body">
                        <div class="panel">
                            <div class="panel-body pan">
                                {!! Form::open(['url'=>'dvvantai/kkdvxkct/store', 'id' => 'create-ctkkgdvlt', 'class'=>'form-horizontal form-validate', 'method'=>'post']) !!}
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 controls">
                                            <input type="text" id="giahl" name="giahl" class="form-control" data-mask="fdecimal" autofocus>
                                        </div>
                                    </div>
