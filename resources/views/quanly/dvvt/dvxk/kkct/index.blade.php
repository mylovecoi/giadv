...
@section('content')
                ...
                <form>
                    <div class="portlet box">
                        <div class="portlet-header">
                            ...
                            <div class="actions">
                                <a href="{{url('dvvantai/kkdvxkct/print/'.$masokk)}}" target="_blank" class="btn btn-info"><i class="fa fa-print"></i> In kê khai </a>
                            </div>
                        </div>
                                                    ...
                                                    <td>
                                                        @if(session('admin')->level == 'H')
                                                            @if($modelkk->trangthai == 'Chờ chuyển')
                                                                    ...
                                                                    <a href="{{url('dvvantai/kkdvxkct/'.$giadv->id.'/edit')}}" class="btn btn-info btn-xs mbs">&nbsp;Chỉnh sửa</a>
    ...
    <script>
        function confirmDelete(id) {
            $('#frmDelete').attr('action', "/dvvantai/kkdvxkct/del/" + id);
        }
    </script>
