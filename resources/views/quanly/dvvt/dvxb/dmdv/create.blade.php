            ...
            <div class="col-lg-12">
                <div class="portlet box">
                    <div class="portlet-header">
                        <div class="caption">
                            <b>THÊM MỚI DỊCH VỤ VẬN TẢI HÀNH KHÁCH BẰNG XE BUÝT</b>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="panel">
                            <div class="panel-body pan">
                                {!! Form::open(['url'=>'dvvantai/dvxb/danhmuc', 'id' => 'create-dmdvvtxb', 'class'=>'form-horizontal form-validate']) !!}
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Đơn vị tính vé lượt
                                        </label>
                                        <div class="col-sm-4 controls">
                                            <input id="dvtluot" class="form-control required" name="dvtluot" type="text" >
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Đơn vị tính vé tháng
                                        </label>
                                        <div class="col-sm-4 controls">
                                            <input id="dvtthang" class="form-control required" name="dvtthang" type="text" >
                                        </div>
                                    </div>
    ...
    <script>
        jQuery(document).ready(function($) {
            $('input[name="madichvu"]').change(function(){
                ...
                $.ajax({
                    type: 'GET',
                    url: '/dvvantai/dvxb/chkdv/'+{{session('admin')->mahuyen}} +'/'+$(this).val(),
                    data: {
                        _token: CSRF_TOKEN
                    },
