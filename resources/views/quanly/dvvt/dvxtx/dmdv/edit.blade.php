            ...
            <div class="col-lg-12">
                <div class="portlet box">
                    <div class="portlet-header">
                        <div class="caption">
                            <b>CHỈNH SỬA THÔNG TIN DỊCH VỤ VẬN TẢI HÀNH KHÁCH BẰNG XE TAXI</b>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="panel">
                            <div class="panel-body pan">
                                {!! Form::model($model, ['method' => 'PATCH', 'url'=>'dvvantai/dvxtx/danhmuc/'. $model->id, 'class'=>'form-horizontal form-validate']) !!}
