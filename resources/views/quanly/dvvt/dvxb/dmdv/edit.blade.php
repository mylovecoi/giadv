            ...
            <div class="col-lg-12">
                <div class="portlet box">
                    <div class="portlet-header">
                        <div class="caption">
                            <b>CHỈNH SỬA THÔNG TIN DỊCH VỤ VẬN TẢI HÀNH KHÁCH BẰNG XE BUÝT</b>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="panel">
                            <div class="panel-body pan">
                                {!! Form::model($model, ['method' => 'PATCH', 'url'=>'dvvantai/dvxb/danhmuc/'. $model->id, 'class'=>'form-horizontal form-validate']) !!}
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 controls">
                                            {!!Form::text('dvtluot', null, array('id' => 'dvt','class' => 'form-control'))!!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 controls">
                                            {!!Form::text('dvtthang', null, array('id' => 'dvt','class' => 'form-control'))!!}
                                        </div>
                                    </div>
