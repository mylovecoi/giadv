            ...
            <div class="col-lg-12">
                <div class="portlet box">
                    <div class="portlet-header">
                        <div class="caption">
                            <b>THÊM MỚI DỊCH VỤ VẬN TẢI KHÁC</b>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="panel">
                            <div class="panel-body pan">
                                {!! Form::open(['url'=>'dvvantai/dvkhac/danhmuc', 'id' => 'create-dmdvvtxk', 'class'=>'form-horizontal form-validate']) !!}
    ...
    <script>
        jQuery(document).ready(function($) {
            $('input[name="madichvu"]').change(function(){
                ...
                $.ajax({
                    type: 'GET',
                    url: '/dvvantai/dvkhac/chkdv/'+{{session('admin')->mahuyen}} +'/'+$(this).val(),
                    data: {
                        _token: CSRF_TOKEN
                    },
